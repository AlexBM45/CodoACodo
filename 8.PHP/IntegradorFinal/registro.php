          ...
          <div class="col col-md-10 offset-md-1 col-lg-8 offset-lg-2 pt-2">
            <form action="registrar.php" method="POST">
              <div class="form-row">
                ...
                <div class="form-group col-12 col-md-12">
                  <input type="text" class="form-control" name="contra" placeholder="password">
                </div>
              ...
              <div class="form-row">
                ...
                <div class="col">
                  <button type="submit" id="botonCalcular" class="btn btn-codo btn-block">Registrarse</button>
                </div>
              </div>
            </form>
          </div>
